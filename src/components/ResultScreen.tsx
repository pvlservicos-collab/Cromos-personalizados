...
export default function ResultScreen({ stickerUrl, stickerId, onRetry, onCheckout, checkoutUrl: checkoutUrlProp, price, ctaText }: ResultScreenProps) {
  const handleCheckout = () => {
    ...
    const checkoutUrl = checkoutUrlProp || "https://folem.mycartpanda.com/checkout/211028517:1";
