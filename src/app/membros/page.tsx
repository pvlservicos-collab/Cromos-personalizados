...
function MembrosContent() {
  ...
  const fetchMember = async (email: string) => {
    ...
    try {
      ...
      if (res.status === 404) { setError("No se encontró ninguna compra para ese email. Comprueba que lo has escrito correctamente."); setData(null); return; }
  ...
  useEffect(() => {
    if (emailParam) { setEmailInput(emailParam); fetchMember(emailParam); }
          ...
          <div style={{
            ...
            <div style={{ textAlign: "center", marginBottom: 24 }}>
              ...
              <p style={{ fontSize: 13, color: "#64748b", margin: 0 }}>
                Usa el mismo email que usaste en la compra
              </p>
            </div>
            <input
              type="email"
