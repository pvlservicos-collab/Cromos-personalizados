...
const FUNNEL_STEPS = [
  ...
  { key: "quiz_3",       label: "Confirmou dados",      color: "#3b82f6" },
    ...
    <div style={{
      ...
      <div style={{
        ...
        <button
          ...
          disabled={loading}
          style={{
            width: "100%", background: "#1d4ed8", border: "none", borderRadius: 10,
    ...
    <aside style={{
        ...
        {NAV_ITEMS.map(item => (
          <button
            ...
            style={{
              ...
              background: tab === item.tab ? "#1d4ed8" : "transparent",
      ...
      <div style={{ padding: "14px 12px", borderTop: "1px solid #1e293b" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }}>
          <div style={{
            width: 34, height: 34, borderRadius: "50%", background: "#3b82f6", flexShrink: 0,
      ...
      <div style={{ background: "#fff", borderRadius: 12, padding: 16, boxShadow: "0 1px 3px rgba(0,0,0,.07)", marginBottom: 20 }}>
        <div style={{ display: "flex", gap: 8, flexWrap: "wrap", marginBottom: 12 }}>
          ...
          <button
            ...
            disabled={loading}
            style={{ background: "#3b82f6", color: "#fff", border: "none", borderRadius: 8, padding: "9px 20px", fontSize: 13, fontWeight: 700, cursor: "pointer", opacity: loading ? 0.7 : 1, whiteSpace: "nowrap" }}
          >
            {loading ? "..." : "Buscar"}
          </button>
        </div>
            ...
            {([["all", "Tudo"], ["today", "Hoje"], ["yesterday", "Ontem"]] as [DateFilter, string][]).map(([d, label]) => (
              <button
                ...
                style={{
                  ...
                  border: `1px solid ${dateFilter === d ? "#3b82f6" : "#e2e8f0"}`,
                  background: dateFilter === d ? "#3b82f6" : "#f8fafc",
              ...
              <div style={{ padding: "8px 10px 4px", flex: 1 }}>
                ...
                {f.telefone ? (
                  <a
                    ...
                    style={{ fontSize: 10, color: "#059669", textDecoration: "none", fontWeight: 600, display: "block", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}
                  >{f.telefone}</a>
                ) : (
                ...
                {f.price_paid != null && (
                  <p style={{ margin: "3px 0 0", fontSize: 10, fontWeight: 800, color: "#059669" }}>
  ...
  return (
    <div style={{ padding: 24, fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" }}>
        ...
        <div style={{ display: "flex", gap: 6, alignItems: "center", flexWrap: "wrap" }}>
          {PERIODS.map(p => (
            <button key={p.key} onClick={() => { setPeriod(p.key); setCountdown(60); }}
              style={{ background: period === p.key ? "#3b82f6" : "#fff", color: period === p.key ? "#fff" : "#64748b", border: `1px solid ${period === p.key ? "#3b82f6" : "#e2e8f0"}`, borderRadius: 6, padding: "5px 12px", cursor: "pointer", fontSize: 12, fontWeight: 600 }}>
              {p.label}
            </button>
          ))}
          <select
            ...
            style={{ background: selectedHour ? "#3b82f6" : "#fff", color: selectedHour ? "#fff" : "#64748b", border: `1px solid ${selectedHour ? "#3b82f6" : "#e2e8f0"}`, borderRadius: 6, padding: "5px 10px", cursor: "pointer", fontSize: 12, fontWeight: 600, outline: "none" }}
          >
        ...
        return (
          <>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 18 }}>
              <div style={chartBox}>
                <h3 style={{ fontSize: 13, fontWeight: 700, color: "#0f172a", margin: "0 0 14px" }}>📈 Sessões por dia (últimos 14 dias)</h3>
      ...
      {sub === "segunda" && (() => {
        ...
        const steps = [
          { label: "Clicaram no botão",    n: seg.cliques,   color: "#3b82f6", pct: 100 },
          ...
          { label: "Obrigados",            n: seg.obrigados, color: "#059669", pct: seg.obrigados / base * 100 },
        ];
        return (
          <div style={{ background: "#fff", borderRadius: 12, padding: 18, boxShadow: "0 1px 3px rgba(0,0,0,.07)" }}>
            <p style={{ margin: "0 0 16px", fontSize: 13, fontWeight: 700, color: "#0f172a" }}>Funil da 2ª Figurinha</p>
    ...
    <div style={{ padding: 24, fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 20, flexWrap: "wrap", gap: 12 }}>
        ...
        <button
          onClick={fetchStats}
          disabled={loading}
          style={{ background: "#3b82f6", color: "#fff", border: "none", borderRadius: 8, padding: "8px 16px", fontSize: 13, fontWeight: 700, cursor: "pointer", opacity: loading ? 0.7 : 1 }}
        >
          {loading ? "..." : "↺ Atualizar"}
        </button>
      </div>
        ...
        <div style={{ display: "flex", gap: 10, flexWrap: "wrap", alignItems: "flex-end" }}>
          <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
            ...
            <input
              ...
              style={{ border: "1px solid #e2e8f0", borderRadius: 8, padding: "8px 12px", fontSize: 13, width: 170, color: "#0f172a" }}
            />
          </div>
          <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
                ...
                <tr key={l.session_id} style={{ borderBottom: "1px solid #f1f5f9" }}>
                  ...
                  <td style={{ padding: "10px 12px" }}>
                    {(() => {
                      ...
                      const MAP = {
                        A:       { bg: "#eff6ff", color: "#1d4ed8", label: "Link A" },
